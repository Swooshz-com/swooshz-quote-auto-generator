...
EXPECTED_VALUES = {
    ...
    "SQAG_PUBLIC_BASE_URL": "<host-configured-dedicated-internal-alpha-https-origin>",
    "OIDC_ISSUER_URL": "https://accounts.google.com",
    "OIDC_REDIRECT_URI": "<host-configured-dedicated-internal-alpha-https-origin>/callback",
