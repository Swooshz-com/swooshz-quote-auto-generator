...
EXACT_PLACEHOLDERS = {
    ...
    "SQAG_INTERNAL_ALLOWED_EMAILS": "<host-secret-manager-exact-tester-email-list>",
    "SQAG_INTERNAL_ADMIN_EMAILS": "<host-secret-manager-exact-admin-email-list>",
    "SQAG_INTERNAL_OPERATOR_EMAILS": "<host-secret-manager-exact-operator-email-list>",
